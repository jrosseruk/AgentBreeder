...
Meetings: Contextual containers where agents interact. Agents cannot "hear" eachother's forward passes. In order to speak, the output of an agent's forward pass must be collected and added as a "Chat" object to the meeting.chats. Only agents present in that meeting can "hear" the chat history.
